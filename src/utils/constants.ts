...
export const ALL_BADGES: Badge[] = [
  { id: 'streak3', label: '3-Day Streak', icon: '🔥', description: 'Study 3+ consecutive days' },
  { id: 'streak5', label: '5-Day Streak', icon: '⚡', description: 'Study 5+ consecutive days' },
  { id: 'streak7', label: '7-Day Streak', icon: '💎', description: 'Study all 7 days' },
  { id: '4h_champ', label: '4h Champion', icon: '🏆', description: 'Average >= 4 hours/day' },
  { id: 'consistency', label: 'Consistency Pro', icon: '🎯', description: 'All 7 days have >= 2 hours each' },
  { id: 'early_bird', label: 'Early Bird', icon: '🐦', description: 'Any session starts before 07:00' },
  { id: 'night_owl', label: 'Night Owl', icon: '🦉', description: 'Any session starts at or after 22:00' },
  { id: 'top3', label: 'Top 3', icon: '🥇', description: 'Ranked in top 3 on the board' },
  { id: 'goal_crusher', label: 'Goal Crusher', icon: '🎉', description: 'Total >= weekly goal' },
  { id: 'lvl5', label: 'Level 5+', icon: '⭐', description: 'Reach level 5 (1500+ total minutes)' },
  { id: 'fact_master', label: 'Fact Master', icon: '📚', description: 'Save 10+ facts in the vault' },
];
...
export const PIN_CARD_COLORS = [
  '#fff8dc', '#ffe4e1', '#f0fff0', '#e6f3ff',
  '#f5f0ff', '#fff5e6', '#f0ffff', '#fff0f5',
  '#fffff0', '#f0f8ff', '#fdf5e6', '#f5fffa',
];

export const THUMBTACK_COLORS = [
  '#e53e3e', '#dd6b20', '#d69e2e', '#38a169',
  '#3182ce', '#805ad5', '#d53f8c', '#2b6cb0',
  '#c05621', '#2f855a', '#6b46c1', '#b83280',
];
